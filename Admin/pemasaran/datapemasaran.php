...
if($op == 'delete'){
    $id = $_GET['id'];
    $sql2 = "DELETE FROM tb_pemasaran where id = '$id'"; 
...
<head>
  ...
  <title>SI DESA||Data Pemasaran</title>
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <th scope="col" class="table-success text-center">NIK</th>
                    <th scope="col" class="table-success text-center">Nama Bisnis</th>
                    <th scope="col" class="table-success text-center">Informasi Bisnis</th>
                  ...
                  <body>
                    ...
                    if(isset($_POST['search'])){
                      $cari = $_POST['cari'];
                      $sql4 = "SELECT * FROM tb_pemasaran where Nama_Bisnis like '%$cari%' order by id desc";
                    }else{
                      $sql4 = "SELECT * FROM tb_pemasaran order by id desc"; 
                    }
                    ...
                    while($r4 = mysqli_fetch_array($q4)){
                        $id          = $r4['id'];
                        $nik         = $r4['NIK'];
                        $nama_bisnis = $r4['Nama_Bisnis'];
                        $desk        = $r4['Deskripsi'];
                        ?>

                        <tr>
                            <td scope="row" class="text-center"><?php echo $urut++ ?></td>
                            <td scope="row" class="text-center"><?php echo $nik ?></td>
                            <td scope="row" class="text-center"><?php echo $nama_bisnis ?></td>
                            <td scope="row" class="text-center"><?php echo $desk ?></td>
                            <td scope="row" class="text-center">
                                <a href="ajupemasaran.php?op=edit&id=<?php echo $id?>"><button type="button" class="btn btn-warning">Edit</button></a>
                                <a href="datapemasaran.php?op=delete&id=<?php echo $id?>" onclick="return confirm('Yakin mau menghapus data?')"><button type="button" class="btn btn-danger">Delete</button></a>
                                <a href="ajupemasaran.php"><button type="button" class="btn btn-success">Tambah</button></a>
