...
if($op == 'delete'){
    $id = $_GET['id'];
    $sql2 = "DELETE FROM tb_informasi where id = '$id'"; 
...
<head>
  ...
  <title>SI DESA||Data Informasi</title>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="forminformasi.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Input Informasi</p>
                </a>
              </li>
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <th scope="col" class="table-success text-center">Nama Informasi</th>
                    <th scope="col" class="table-success text-center">Deskripsi</th>
                  ...
                  <body>
                    ...
                    if(isset($_POST['search'])){
                      $cari = $_POST['cari'];
                      $sql4 = "SELECT * FROM tb_informasi where nama like '%$cari%' order by id desc";
                    }else{
                    ...
                    while($r4 = mysqli_fetch_array($q4)){
                        ...
                        <tr>
                            ...
                            <td scope="row" class="text-center">
                                <a href="forminformasi.php?op=edit&id=<?php echo $id?>"><button type="button" class="btn btn-warning">Edit</button></a>
