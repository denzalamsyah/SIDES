...
if($op == 'delete'){
    $id = $_GET['id'];
    $sql5 = "DELETE FROM tb_arsip where id = '$id'"; 
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <th scope="col" class="table-success text-center">Kategori</th>
                  ...
                  <body>
                    ...
                    if(isset($_POST['search'])){
                      $cari = $_POST['cari'];
                      $sql5 = "SELECT * FROM tb_arsip where kategori like '%$cari%' order by id desc";
                    }else{
                      $sql5 = "SELECT * FROM tb_arsip order by id desc"; 
                    }
                    ...
                    while($r5 = mysqli_fetch_array($q5)){
                        ...
                        <tr>
                            ...
                            <td scope="row" class="text-center"><?php echo $id_surat ?></td>
                            <td scope="row" class="text-center"><?php echo $kategori ?></td>
                            <td scope="row" class="text-center"><?php echo $tanggal ?></td>
                            <td scope="row" class="text-center">
                                <a href="formarsip.php?op=edit&id=<?php echo $id?>"><button type="button" class="btn btn-warning">Edit</button></a>
                                <a href="dataarsip.php?op=delete&id=<?php echo $id?>" onclick="return confirm('Yakin mau menghapus data?')"><button type="button" class="btn btn-danger">Delete</button></a>
                                <a href="formarsip.php"><button type="button" class="btn btn-success">Tambah</button></a>
