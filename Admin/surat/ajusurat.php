...
if($op == 'edit'){
  $id          = $_GET['id'];
  $sql5        = "SELECT * FROM tb_surat where id = '$id'";
...
if (isset($_POST['submit'])) {
  ...
  if($nikpe && $nape && $namsu && $tusu && $tanggal){
    ...
    if($op == 'edit'){ //untuk update
      $sql3 = "UPDATE tb_surat set nama_surat = '$namsu', tanggal = '$tanggal', NIK_pembuat = '$nikpe', tujuan_surat = '$tusu', nama_pengirim = '$nape' where id = '$id'";
