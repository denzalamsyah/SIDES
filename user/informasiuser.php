        ...
        <div class="row">
          <div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="https://jabar.wartanusa.id/gema-muharam-1442-h-di-peringati-warga-desa-cipancar-kecamatan-leles-kabupaten-garut/" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-success">
              ...
              <a href="https://beritadiy.pikiran-rakyat.com/tag/PKH" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-4 col-6">
      ...
      <div class="card bg-gradient-danger">
        <div class="card-header border-">
          ...
          <div class="inner">
            <div class="row">
              <div class="col-lg-4 col-6">
                <img src="gempa.jpg" alt="Foto Korban">
                <p>Korban Bencana 256 Jiwa</p>
              </div>
            <!-- <div class="col-lg-4 col-4">
              <img src="gempa2.jpg" alt="Foto Korban">
            </div> -->
              </div>
              <a href="https://www.detik.com/tag/bencana-di-cianjur" class="small-box-footer text-dark"><b>More info</b> <i class="fas fa-arrow-circle-right"></i></a>
              </div>
          </div>
          <!-- /.card-tools -->
        </div>
            ...
            <div class="container-fluid">
                <div class="row">
                  <div class="col-12">
                    <div class="card">
                      <div class="card-header border">
                        <h2 class="card-title"><b>Informasi Penting</b></h32>
                      </div>
                      <!-- /.card-header -->
                      <div class="card-body">
                        <table id="example2" class="table table-bordered table-hover">
                          <thead>
                          <tr>
                            <th scope="col" class="table-danger text-center">NO</th>
                            <th scope="col" class="table-danger text-center">Nama Informasi</th>
                            <th scope="col" class="table-danger text-center">Deskripsi</th>
                          </tr>
                          <body>
                            <?php
                            $sql4 = "SELECT * FROM tb_informasi order by id desc";
                            ...
                            while($r4 = mysqli_fetch_array($q4)){
                                ...
                                <tr>
                                    ...
                                    <td scope="row" class="text-center"><?php echo $desk ?></td>
                                </tr>
                                <?php
                            }
                            ?>
